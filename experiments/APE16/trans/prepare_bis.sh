...
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.src < ${raw_data}/4M.src > ${data_dir}/raw.src 2>/dev/null
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/4M.mt > ${data_dir}/raw.mt 2>/dev/null
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/4M.pe > ${data_dir}/raw.pe 2>/dev/null
...
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${data_dir}/raw.mt > ${data_dir}/train.true.mt 2>/dev/null
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${data_dir}/raw.pe > ${data_dir}/train.true.pe 2>/dev/null
...
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/dev.mt > ${data_dir}/dev.true.mt 2>/dev/null
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/dev.pe > ${data_dir}/dev.true.pe 2>/dev/null
...
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/test.mt > ${data_dir}/test.true.mt 2>/dev/null
${mosesdecoder}/scripts/recaser/truecase.perl --model ${data_dir}/truecaser.de < ${raw_data}/test.pe > ${data_dir}/test.true.pe 2>/dev/null
